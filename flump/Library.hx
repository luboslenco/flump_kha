...
class Library
{
    ...
    /**
     * Creates a library from json data.
     */
    public function new (data :String)
    {
        var _file = kha.Loader.the.getBlob(data).toString();
        var json :Format = Json.parse(_file);
        ...
        for (atlasObject in atlases) {
            var atlas = kha.Loader.the.getImage(atlasObject.file);
